...
FMTONE = ModuleSpec(
    ...
    global_params=[
        ...
        P("fmtone.harm", "Harmonics", rmin=-26.0, rmax=26.0, default=0.0, curve=Curve.BIPOLAR, formatter="float2", musical=(-13.0, 13.0)),
        ...
        P("fmtone.aLev", "A Level", rmin=0.0, rmax=127.0, default=85.0, formatter="int", danger=DangerClass.LOUDNESS, musical=(28.0, 72.0)),
        ...
        P("fmtone.bLev", "B Level", rmin=0.0, rmax=127.0, default=0.0, formatter="int", danger=DangerClass.LOUDNESS, musical=(0.0, 58.0)),
